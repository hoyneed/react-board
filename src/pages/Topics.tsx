                ...
                <div className="main__container w-full max-w-332 flex-1 flex p-6">
                    <SidebarProvider>
                        ...
                        <div className="main__container__contents h-full w-[calc(100%-256px)] flex flex-col">
                            <div className="hot h-106 w-full flex flex-col p-2">
                                <div className="hot__header h-14 w-full flex flex-col gap-1">
                            ...
                            <div className="new w-full flex-1 flex flex-col p-2">
                                ...
                                <div className="w-full flex-1 grid grid-cols-2 justify-between gap-4 sm:gap-6 m-2 overflow-auto">
                                    <HotCard />
                                    <HotCard />
                                    <HotCard />
                                    <HotCard />
