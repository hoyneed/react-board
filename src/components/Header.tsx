function Header() {
    return (
        <div className="header w-full h-13 flex items-center justify-between gap-4 px-6 bg-neutral-900">
            <div className="header__front h-full flex-1 flex items-center justify-start gap-4">
                ...
                <button className="text-white text-sm font-semibold cursor-pointer pr-4 border-r-1 border-neutral-500">
                    배움 노트
                </button>
                <button className="text-white text-sm font-semibold cursor-pointer pr-4 border-r-1 border-neutral-500">
                    토픽 인사이트
